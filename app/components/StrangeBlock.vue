...
<Section>
  <div class="container">
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-5 mb-16">
      <div class="flex lg:flex-col justify-between lg:items-start lg:justify-start">
  ...
  <div class="container block lg:hidden py-0">
